/* This version of the library is slightly different than the origianl version of Genann since it was modified to fit our use case
...
double const *genann_run(genann const *ann, double const *inputs) {
    ...
    //printf("hello [%1.f , %1.f]",ret+0,ret+1);
    return ret;
}
